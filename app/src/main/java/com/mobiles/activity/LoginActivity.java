...
import com.mobiles.entity.User;
import com.mobiles.util.MobileConstants;
...
public class LoginActivity extends AppCompatActivity {
    ...
    private void initFirebase() {
        ...
        mAuthListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (user != null) {
                    // User is signed in
                    MobileConstants.UID = user.getUid();
    ...
    public void clickRegisterLayout(View view) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            ...
            startActivityForResult(new Intent(this, RegisterActivity.class), MobileConstants.REQUEST_CODE_REGISTER, options.toBundle());
        } else {
            startActivityForResult(new Intent(this, RegisterActivity.class), MobileConstants.REQUEST_CODE_REGISTER);
        }
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == MobileConstants.REQUEST_CODE_REGISTER && resultCode == RESULT_OK) {
            authUtils.createUser(data.getStringExtra(MobileConstants.STR_EXTRA_USERNAME), data.getStringExtra(MobileConstants.STR_EXTRA_PASSWORD));
        }
    }
    ...
    class AuthUtils {
        ...
        void saveUserInfo() {
            ...
            FirebaseDatabase.getInstance().getReference().child("user/" + MobileConstants.UID).addListenerForSingleValueEvent(new ValueEventListener() {
                @Override
