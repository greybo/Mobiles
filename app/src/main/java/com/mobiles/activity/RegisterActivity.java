...
public class RegisterActivity extends AppCompatActivity {
    ...
    public void clickRegister(View view) {
        ...
        if (validate(username, password, repeatPassword)) {
            ...
            data.putExtra(MobileConstants.STR_EXTRA_USERNAME, username);
            data.putExtra(MobileConstants.STR_EXTRA_PASSWORD, password);
            data.putExtra(MobileConstants.STR_EXTRA_ACTION, STR_EXTRA_ACTION_REGISTER);
